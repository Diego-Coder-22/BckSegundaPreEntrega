const logout = async () => {
    ...
    try {
        const response = await fetch('https://bcksegundapreentrega-production.up.railway.app/api/sessions/logout', {
            method: 'GET',
            headers: {
...
const perfil = async () => {
    ...
    try {
        const response = await fetch(`https://bcksegundapreentrega-production.up.railway.app/api/sessions/dashboard/${userId}`, {
            method: 'GET',
            headers: {
                "authorization": `Bearer ${token}`
            }
...
const changePassword = async () => {
    ...
    try {
        const response = await fetch(`https://bcksegundapreentrega-production.up.railway.app/api/sessions/changePassword/${userId}`, {
            method: 'GET',
            headers: {
                "authorization": `Bearer ${token}`
            }
...
const chat = async () => {
    ...
    try {
        const response = await fetch(`https://bcksegundapreentrega-production.up.railway.app/api/messages`, {
            method: 'GET',
            headers: {
                "authorization": `Bearer ${token}`
            }
        ...
        if (response.ok) {
            window.location.replace(`https://bcksegundapreentrega-production.up.railway.app/api/messages`);
        } else {
            const errorMessage = await response.text();
...
const changePremiumRole = async () => {
    ...
    try {
        const response = await fetch(`https://bcksegundapreentrega-production.up.railway.app/api/sessions/premium/${userId}`, {
            method: 'GET',
            headers: {
                "authorization": `Bearer ${token}`
            }
        ...
        if (response.ok) {
            window.location.replace(`https://bcksegundapreentrega-production.up.railway.app/api/sessions/premium/${userId}`);
        } else {
            const errorMessage = await response.text();
...
const changeUserRole = async () => {
    ...
    try {
        const response = await fetch(`https://bcksegundapreentrega-production.up.railway.app/api/sessions/user/${userId}`, {
            method: 'GET',
            headers: {
                "authorization": `Bearer ${token}`
            }
        ...
        if (response.ok) {
            window.location.replace(`https://bcksegundapreentrega-production.up.railway.app/api/sessions/user/${userId}`);
        } else {
            const errorMessage = await response.text();
            console.error('Error en ir a cambiar roles:', errorMessage);
        }
...
const uploadDocs = async () => {
    ...
    try {
        const response = await fetch(`https://bcksegundapreentrega-production.up.railway.app/api/sessions/${userId}/uploadDocuments`, {
            method: 'GET',
            headers: {
                "authorization": `Bearer ${token}`
            }
        ...
        if (response.ok) {
            window.location.replace(`https://bcksegundapreentrega-production.up.railway.app/api/sessions/${userId}/uploadDocuments`);
        } else {
            const errorMessage = await response.text();
