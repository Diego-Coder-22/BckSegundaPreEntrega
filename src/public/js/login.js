...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', function (event) {
            ...
            fetch('https://bcksegundapreentrega-production.up.railway.app/api/sessions/login', {
                method: 'POST',
            ...
            .then(data => {
                ...
                if (userRole === 'admin') {
                    window.location.href = `https://bcksegundapreentrega-production.up.railway.app//api/sessions/dashboard/${userId}`;
                }
                else {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if(githubButton) {
        githubButton.addEventListener("click", function(event) {
            ...
            fetch('https://bcksegundapreentrega-production.up.railway.app/api/sessions/github', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json' 
                }
